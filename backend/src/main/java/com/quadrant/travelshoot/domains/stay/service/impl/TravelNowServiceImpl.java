...
public class TravelNowServiceImpl implements TravelNowService {
    ...
    private List<TravelNowResponse> getDbDestinations() {
        ...
        dbDestinations.add(TravelNowResponse.builder()
            ...
            .name("제주")
            .location("제주특별자치도")
            .image("https://travelshoot-s3.s3.ap-southeast-2.amazonaws.com/images/main/travelNow/6adc0728-a898-4cf1-971e-f1fa7d181736_TrvaelNowJeju.jpg")
        ...
        dbDestinations.add(TravelNowResponse.builder()
            ...
            .name("강릉")
            .location("강원도")
            .image("https://travelshoot-s3.s3.ap-southeast-2.amazonaws.com/images/main/travelNow/26c4a0d1-96a6-4e9f-a40b-953d77ddf9cf_TrvaelNowGangleung.jpg")
        ...
        dbDestinations.add(TravelNowResponse.builder()
            ...
            .name("춘천")
            .location("강원도")
            .image("https://travelshoot-s3.s3.ap-southeast-2.amazonaws.com/images/main/travelNow/f65ae424-2648-46db-b0ac-c07db9dcfcab_TrvaelNowChuncheon.jpg")
