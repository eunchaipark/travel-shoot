...
public class TravelNowService {
    ...
    // DB 데이터 가져오기 (강원도, 제주도)
    public List<TravelNowResponse> getDbDestinations() {
    ...
    public List<TravelNowResponse> getUtilDestinations() {
    ...
    public List<TravelNowResponse> getAllTravelNowDestinations() {
        ...
        return allDestinations.stream()
                .sorted(Comparator.comparingLong(TravelNowResponse::getId))
