    ...
    options: [
      {
        value: "서울",
        label: "서울",
        image: "/images/survey/survey-seoul.svg",
      },
      {
        value: "부산",
        label: "부산",
        image: "/images/survey/survey-busan.svg",
      },
      {
        value: "제주도",
        label: "제주도",
        image: "/images/survey/survey-jeju.svg",
      },
      {
        value: "경상도",
        label: "경상도",
        image: "/images/survey/survey-Gyeongsang-do.svg",
      },
      {
        value: "강원도",
        label: "강원도",
        image: "/images/survey/survey-Gangwon-do.svg",
      },
      {
        value: "전라도",
        label: "전라도",
        image: "/images/survey/survey-jeollado.svg",
      },
      {
        value: "충청도",
        label: "충청도",
        image: "/images/survey/survey-chungcheong-do.svg",
      },
    ...
    options: [
      {
        value: "한식",
        label: "한식",
        image: "/images/survey/survey-koreanfood.svg",
      },
      {
        value: "중식",
        label: "중식",
        image: "/images/survey/survey-chinesefood.svg",
      },
      {
        value: "일식",
        label: "일식",
        image: "/images/survey/survey-japanesefood.svg",
      },
      {
        value: "양식",
        label: "양식",
        image: "/images/survey/survey-westernfood.svg",
      },
      ...
      },
      {
        value: "디저트",
        label: "디저트",
        image: "/images/survey/survey-dessert.svg",
      },
    ],
  },
    ...
    options: [
      {
        value: "자연관광",
        label: "자연관광",
        image: "/images/survey/survey-naturaltourism.svg",
      },
      {
        value: "문화체험",
        label: "문화체험",
      ...
      },
      {
        value: "쇼핑",
        label: "쇼핑",
        image: "/images/survey/survey-shoping.svg",
      },
      {
        value: "맛집탐방",
        label: "맛집탐방",
        image: "/images/survey/survey-restauranttour.svg",
      },
      {
        value: "사진",
        label: "사진",
